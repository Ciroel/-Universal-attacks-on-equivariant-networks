...
import FGSM.utils.utils
from FGSM.utils.utils import str2bool
from FGSM.solver import Solver
...
def main(args):
    ...
    if args.mode == 'train':
        ...
        net.generate__(num_sample=args.batch_size,
                     target=args.target,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=10000, help='mini-batch size')
    ...
    parser.add_argument('--architecture', type=str, default='RotEqNet', help='architecture for attack')
