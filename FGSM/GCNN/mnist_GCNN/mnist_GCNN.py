...
# test_loader = torch.utils.data.DataLoader(  # Anton
...
#
#
def test_score(perturbation=None):
    ...
    for data, target in test_loader:
        ...
        # data = data + perturbation
        output = model(data)
        test_loss += F.nll_loss(output, target, size_average=False).data# [0] # sum up batch loss  # Anton
...
# model.load_state_dict(torch.load('best_model_GCNN.pt'))
